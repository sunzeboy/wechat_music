...
(function () {
  ...
  function doUpload(filePath, success, fail, options, progress) {
    ...
    if (!config.qiniuShouldUseQiniuFileName) {
      formData['key'] = 'volk-box-xcx/' + Date.parse(new Date()) + md5.hex_md5(fileName)
      formData['x:name'] = 'volk-box-xcx/' + Date.parse(new Date()) + md5.hex_md5(fileName)
      formData['x:client'] = 'volk-box-xcx'
      formData['x:type'] = 'image'
    }
